      ...
      <div className="relative hidden md:block">
        ...
        >
          ...
          <button
            ...
            className="absolute md:right-5 right-6 top-4 border-gray-300 pl-4 text-2xl border-l-2 text-gray-400"
          >
            <BiSearch />
          </button>
        </form>
      ...
      <div>
        {userProfile ? (
          <div className="flex gap-5 md:gap-10">
            <Link href="/upload">
              <button className="border-2 px-2 p-2 md:px-4 text-md font-semibold flex items-center gap-2">
